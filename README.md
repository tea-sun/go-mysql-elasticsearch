...
+ `go get github.com/go-mysql-org/go-mysql-elasticsearch`, it will print some messages in console, skip it. :-)
+ cd `$GOPATH/src/github.com/go-mysql-org/go-mysql-elasticsearch`
+ `make`
